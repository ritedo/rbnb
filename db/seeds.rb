...
Reservation.create(user_id: 2, bike_id: 1, starts_at: DateTime.new(2017,12,2), ends_at: DateTime.new(2017,12,4))
Reservation.create(user_id: 2, bike_id: 2, starts_at: DateTime.new(2017,12,5), ends_at: DateTime.new(2017,12,7))
